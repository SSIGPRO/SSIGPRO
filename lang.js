const i18n = {
  it: {
    ...
    research_intro: "Il gruppo SSIGPRO sviluppa metodi teorici e algoritmici per estrarre informazione affidabile da dati e segnali complessi.",
    ...
    research_note: "Le linee di ricerca combinano modellazione matematica, validazione sperimentale e trasferimento verso applicazioni reali.",
    team_title: "Team",
    ...
    role_rovatti: "Professore ordinario - Coordinamento scientifico",
    role_mangia: "Ricercatore - Metodi di machine learning e inferenza",
    role_setti: "Professore ordinario - Collaborazioni e applicazioni",
    team_note: "Il gruppo include docenti, ricercatori e collaboratori impegnati su temi teorici e applicativi dell'elaborazione statistica dei segnali.",
  ...
  en: {
    ...
    research_intro: "The SSIGPRO group develops theoretical and algorithmic methods to extract reliable information from complex data and signals.",
    ...
    research_note: "Research lines combine mathematical modeling, experimental validation, and transfer to real-world applications.",
    team_title: "Team",
    team_intro: "Reference profiles and academic collaborations of the group.",
    aff_unibo: "University of Bologna",
    aff_polito: "Politecnico di Torino",
    role_rovatti: "Full Professor - Scientific coordination",
    role_mangia: "Researcher - Machine learning and inference methods",
    role_setti: "Full Professor - Collaborations and applications",
    team_note: "The group includes faculty members, researchers, and collaborators working on theoretical and applied statistical signal processing.",
